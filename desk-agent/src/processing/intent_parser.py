...
# This is the corrected master prompt. 
# All literal curly braces for the JSON examples have been doubled (e.g., {{ and }}) 
# to prevent conflicts with Python's .format() method.
SYSTEM_PROMPT = """
